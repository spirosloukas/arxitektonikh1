...
loop: 			mul.s $f1,$f1,$f2	# f1 = f1 * f2
				...
				jal print_msg2		# NOW, PRINT THE FACTORIAL AS INT
				cvt.w.s $f26, $f1	# convert the i! into an INT and save it into f26
				mfc1 $a0, $f26		# Then, move that INT into $a0 of the CPU, to print it as INT
				li $v0,1			# print int
				syscall
